...
} from '../../lib/shared/system-prompt.ts'
import { Card, Loading, ErrorBox, PageHeader, PanelHeader, useToast } from '../../components/UI.jsx'
...
import { AlertCircleIcon, BrainIcon, CheckCircleIcon, RefreshCwIcon, SaveIcon } from '../../components/Icons.jsx'
export default function Settings() {
  ...
  const handleSaveAi = async (e) => {
    ...
    try {
      ...
      if (resp?.config) {
        setCfg({ ...resp.config, ai_api_key: '', ai_api_key_clear: false })
      }
      success('AI 配置已保存')
    } catch (e) {
      toastError(e.message)
                ...
                <div className="space-y-3">
                  <label className="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-100 px-4 py-3">
                    ...
                    <Checkbox
                      ...
                      onCheckedChange={(v) =>
                        setCfg({ ...cfg, ai_group_reply_quote_enabled: v })
                      }
                    />
                  </label>
                  ...
                  <label className="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-100 px-4 py-3">
                    ...
                    <Checkbox
                      ...
                      onCheckedChange={(v) =>
                        setCfg({ ...cfg, ai_group_reply_quote_prefer_quoted: v })
                      }
                    />
                  </label>
                </div>
                ...
                <div className="space-y-3">
                  <label className="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-100 px-4 py-3">
                    ...
                    <Checkbox
                      ...
                      onCheckedChange={(v) =>
                        setCfg({ ...cfg, ai_group_context_enabled: v })
                      }
                    />
                  </label>
                  ...
                  <label className="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-100 px-4 py-3">
                    ...
                    <Checkbox
                      ...
                      onCheckedChange={(v) =>
                        setCfg({ ...cfg, ai_group_context_include_quote: v })
                      }
                    />
                  </label>
                  ...
                  <label className="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-100 px-4 py-3">
                    ...
                    <Checkbox
                      ...
                      onCheckedChange={(v) =>
                        setCfg({ ...cfg, ai_group_context_exclude_bot: v })
                      }
                    />
                  </label>
                </div>
                ...
                <div className="space-y-3">
                  <label className="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-100 px-4 py-3">
                    ...
                    <Checkbox
                      ...
                      onCheckedChange={(v) =>
                        setCfg({ ...cfg, ai_google_search_enabled: v })
                      }
                    />
                  </label>
                  ...
                  <label className="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-100 px-4 py-3">
                    ...
                    <Checkbox
                      ...
                      onCheckedChange={(v) =>
                        setCfg({ ...cfg, ai_url_context_enabled: v })
                      }
                    />
                  </label>
                </div>
